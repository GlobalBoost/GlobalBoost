...
static void SetupGlobalBoostTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " globalboost-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  globalboost-tx [options] <hex-tx> [commands]  Update hex-encoded globalboost transaction\n" +
            "or:     globalboost-tx [options] -create [commands]   Create hex-encoded globalboost transaction\n" +
            "\n";
