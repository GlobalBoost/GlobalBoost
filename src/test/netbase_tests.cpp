// Copyright (c) 2012-2018 The GlobalBoost Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.globalboostcore.org", "www.globalboostcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.globalboostcore.org]", "www.globalboostcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.globalboostcore.org:80", "www.globalboostcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.globalboostcore.org]:80", "www.globalboostcore.org", 80));
