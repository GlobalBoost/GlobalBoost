/* src/config/globalboost-config.h.  Generated from globalboost-config.h.in by configure.  */
/* src/config/globalboost-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef GLOBALBOOST_CONFIG_H

#define GLOBALBOOST_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The GlobalBoost Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "GlobalBoost Core"
...
#define PACKAGE_BUGREPORT "https://github.com/globalboost/globalboost/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "GlobalBoost Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "GlobalBoost Core 0.17.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "globalboost"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://globalboostcore.org/"
