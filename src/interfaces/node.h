...
#ifndef GLOBALBOOST_INTERFACES_NODE_H
#define GLOBALBOOST_INTERFACES_NODE_H
...
//! Top-level interface for a globalboost node (globalboostd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // GLOBALBOOST_INTERFACES_NODE_H
