...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("globalboost://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'globalboost://' is not a valid URI. Use 'globalboost:' instead."),
            CClientUIInterface::MSG_ERROR);
    }
    else if (s.startsWith(GLOBALBOOST_IPC_PREFIX, Qt::CaseInsensitive)) // globalboost: URI
    {
